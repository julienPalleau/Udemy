...
class Game:
    ...
    def create_button(self):
        self.reset_button = Button(
            self.fond, "   Reset   ", RED, self.small, 0, 300)
        self.start_button = Button(
            self.fond, "   Start   ", RED, self.small, 0, 360)
        self.quit_button = Button(
            self.fond, "   Quit   ", RED, self.small, 0, 420)
        self.moins_button = Button(
            self.fond, "  -  ", GREEN, self.small, -100, 200)
        ...
        while self.loop:
            ...
            for event in pygame.event.get():
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    self.moins_button.update_button(
                        self.fond, action=self.moins)
