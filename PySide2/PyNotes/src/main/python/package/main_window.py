...
class MainWindow(QtWidgets.QWidget):
    ...
    def setup_connections(self):
        ...
        QtWidgets.QShortcut(QtGui.QKeySequence("Backspace"), self.lw_notes, self.delete_selected_notes)
    ...
    def get_selected_lw_item(self):
        self.lw_notes.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection) # Permet de ne pas
                                                                        # selectionner d'element dans la list widget.
