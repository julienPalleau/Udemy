...
def get_notes():
    notes = []
    fichiers = glob(os.path.join(NOTES_DIR, "*.json")) #glob permet de recuperer tous les fichiers
...
class Note:
    ...
    @property
    def content(self):
        return self._content  # attribut prive pour eviter une erreur de recursion.
    ...
    @property  # Creation d'une propriete pour pouvoir appeler n.path au lieu de n.path()
    def path(self):
